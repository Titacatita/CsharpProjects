...
namespace QuantBook.Ch08
{
    ...
    public class SvmViewModel : Screen
    {
        ...
        private double[] SvmClassification(DataTable dtData)
        {
            ...
            MulticlassSupportVectorMachine machine = new MulticlassSupportVectorMachine(inputs: 4, kernel: kernel, classes: 3);
            MulticlassSupportVectorLearning teacher = new MulticlassSupportVectorLearning(machine, inputTrain, outputTrain);
        ...
        private void SvmRegression(DataTable dtData)
        {
            ...
            KernelSupportVectorMachine machine = new KernelSupportVectorMachine(kernel, inputs: 4);
            SequentialMinimalOptimizationRegression learn = new SequentialMinimalOptimizationRegression(machine, inputTrain, outputTrain);
