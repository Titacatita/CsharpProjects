...
namespace QuantBook.Ch06
{
    ...
    public class SimplePcaViewModel : Screen
    {
        [ImportingConstructor]
        public SimplePcaViewModel()
        {
            DisplayName = "02. Simple PCA";
        ...
        private void IndexCharts()
        {
            ...
            SimpleLinearResult slr = LinearAnalysisHelper.GetSimplePca(IndexData, "SPX", "HYSpread");
            ...
            HySpxCollection.AddRange(MSChartHelper.ScatterChart(IndexData, "SPX", "HYSpread", RegressionType.SimplePca));

            HyVixCollection.Clear();
            slr = LinearAnalysisHelper.GetSimplePca(IndexData, "VIX", "HYSpread");
            ...
            HyVixCollection.AddRange(MSChartHelper.ScatterChart(IndexData, "VIX", "HYSpread", RegressionType.SimplePca));
        }

        private void StockCharts()
        {
            Stock1Collection.Clear();
            SimpleLinearResult slr = LinearAnalysisHelper.GetSimplePca(StockData, "Price1", "Price2");
            ...
            Stock1Collection.AddRange(MSChartHelper.ScatterChart(StockData, "Price1", "Price2", RegressionType.SimplePca));

            Stock2Collection.Clear();
            slr = LinearAnalysisHelper.GetSimplePca(StockReturnData, "Price1", "Price2");
            ...
            Stock2Collection.AddRange(MSChartHelper.ScatterChart(StockReturnData, "Price1", "Price2", RegressionType.SimplePca));
        }
    }
}
