...
namespace QuantBook.Ch03
{
    ...
    public class AggregateViewModel : Screen
    {
        ...
        public void GetAggregate()
        {
            ...
            _events.PublishOnUIThread(new ModelEvents(new List<object>(new object[] { "From Aggregates: Count = " + MyAggregates.Count.ToString() })));
        }
        ...
        public void GetPivot()
        {
            ...
            _events.PublishOnUIThread(new ModelEvents(new List<object>(new object[] { "From Pivots: Count = " + MyPivots.Count.ToString() })));
        }
    }
