...
namespace QuantBook.Ch09
{
    ...
    public class AmericanBAWViewModel : Screen
    {
        ...
        private void InitializeModel()
        {
            ...
            OptionTable.Columns.Add("BAWValue", typeof(float));
            OptionTable.Columns.Add("Calculated", typeof(float));
        ...
        public void CalculatePrice()
        {
            ...
            foreach(DataRow row in InputTable.Rows)
            {
                ...
                double price = OptionHelper.American_BaroneAdesiWhaley(optionType, spot, strike, rate, div, maturity, vol);
