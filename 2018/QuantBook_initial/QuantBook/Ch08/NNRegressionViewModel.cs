...
namespace QuantBook.Ch08
{
    ...
    public class NNRegressionViewModel : Screen
    {
        ...
        private void NnRegression()
        {
            ...
            LevenbergMarquardtLearning lm = new LevenbergMarquardtLearning(network);
            lm.LearningRate = LearningRate;
            ParallelResilientBackpropagationLearning rprop = new ParallelResilientBackpropagationLearning(network);
