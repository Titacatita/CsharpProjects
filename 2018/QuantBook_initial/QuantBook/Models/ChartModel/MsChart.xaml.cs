...
namespace QuantBook.Models.ChartModel
{
    ...
    public partial class MsChart : UserControl
    {
        ...
        {
            MsChart ms = sender as MsChart;
            BindableCollection<Series> sc = e.NewValue as BindableCollection<Series>;
            if (sc != null)
        ...
        {
            MsChart ms = sender as MsChart;
            object sc = e.NewValue as object;
            if (sc != null)
            {
